...
import 'package:secure_evoting_app/feautures/election_result/presentation/election_detail_result.dart';

class ResultElectionCard extends StatelessWidget {
  final ElectionsModel election;
  const ResultElectionCard({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Get.to(() => ElectionDetailResultScreen(election: election),
